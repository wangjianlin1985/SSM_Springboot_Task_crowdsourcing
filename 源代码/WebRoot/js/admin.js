		       ...
		       text: "任务分类管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "TaskClass/taskClass_add.jsp"
			    	   	},
			    		{
			    	   		text: "任务分类管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "TaskClass/taskClass_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "任务管理",
		       ...
		       text: "任务状态管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "TaskState/taskState_add.jsp"
			    	   	},
			    		{
			    	   		text: "任务状态管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "TaskState/taskState_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "任务领取管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "TaskGet/taskGet_add.jsp"
			    	   	},
			    		{
			    	   		text: "任务领取管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "TaskGet/taskGet_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻公告管理",
