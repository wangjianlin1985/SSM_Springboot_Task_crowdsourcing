...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">任务众包网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>UserInfo/frontlist">用户查询</a></li>
                <li><a href="<%=basePath %>TaskClass/frontlist">任务分类</a></li>
                <li><a href="<%=basePath %>Task/frontlist">任务列表</a></li>
                <!--  <li><a href="<%=basePath %>TaskState/frontlist">任务状态</a></li> -->
                <li><a href="<%=basePath %>TaskGet/frontlist">任务领取进度</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Task/task_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布任务</a></li>
                        <li><a href="<%=basePath %>Task/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的任务</a></li>
                        <li><a href="<%=basePath %>TaskGet/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我领取的任务</a></li>
