	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_skillContent" class="col-md-2 text-right">个人能力:</label>
				  	 <div class="col-md-8">
							    <textarea name="userInfo.skillContent" id="userInfo_skillContent" style="width:100%;height:500px;"></textarea>
					 </div>
				  </div>
...
<script>
//实例化编辑器
var userInfo_skillContent_editor = UE.getEditor('userInfo_skillContent'); //个人能力编辑器
var basePath = "<%=basePath%>";
	...
	function ajaxUserInfoAdd() { 
		...
		if(userInfo_skillContent_editor.getContent() == "") {
			alert('个人能力不能为空');
			return;
		}
		jQuery.ajax({
			...
			success : function(obj) {
				if(obj.success){ 
					...
					userInfo_skillContent_editor.setContent("");
				} else {
					alert(obj.message);
				}
			},
