...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<ul class="breadcrumb">
		...
		<div class="row"> 
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_skillContent_edit" class="col-md-3 text-right">个人能力:</label>
		  	 <div class="col-md-9">
			    <script name="userInfo.skillContent" id="userInfo_skillContent_edit" type="text/plain"   style="width:100%;height:500px;"></script>
			 </div>
		  </div>
...
<script>
var userInfo_skillContent_editor = UE.getEditor('userInfo_skillContent_edit'); //个人能力编辑框
var basePath = "<%=basePath%>";
/*弹出修改用户界面并初始化数据*/
function userInfoEdit(user_name) {
  userInfo_skillContent_editor.addListener("ready", function () {
    // editor准备好之后才可以使用 
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				userInfo_skillContent_editor.setContent(userInfo.skillContent, false);
