    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			 	<textarea name="userInfo.skillContent" id="userInfo_skillContent_edit" style="width:100%;height:500px;"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
...
<script>
//实例化编辑器
var userInfo_skillContent_edit = UE.getEditor('userInfo_skillContent_edit'); //个人能力编辑器
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				userInfo_skillContent_edit.setContent(userInfo.skillContent, false);
